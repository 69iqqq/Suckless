...
/*static char font[]           		 = "Iosevka:style:medium:size=10";*/
static char dmenufont[]      		 = "IosevkaMayukaiCodePro:size=10";
/*static const char *fonts[]         	 = { font, "SymbolsNerdFont:size=14", };*/
static const char *fonts[]          = {"Iosevka:style:medium:size=09" ,"JetBrainsMono Nerd Font Mono:style:medium:size=19" };
...
static const char *pmenucmd[]   = { "/home/abir/.local/bin/pmenu", NULL };
...
/* dmenuemojicmd */
static const char *emojicmd[]   = { "/home/abir/.local/bin/dmenuunicode",   NULL };
